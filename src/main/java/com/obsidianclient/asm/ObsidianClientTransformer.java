...
public interface ObsidianClientTransformer {

    /**
     * Specify the class you want to transform here,
     * as example: net.minecraft.client.Minecraft
     * @return name of the class to transform
     */
    String getClassToTransform();

    /**
     * Transform your class here.
     * @param clazz your class in ASM format
     */
