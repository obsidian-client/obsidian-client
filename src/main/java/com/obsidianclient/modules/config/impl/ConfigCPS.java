...
import com.obsidianclient.modules.impl.ModuleCPS;
import net.minecraft.client.gui.GuiButton;

import java.awt.*;
import java.io.IOException;

//The config screen for the CPS module:
public class ConfigCPS extends GuiModuleConfigScreen {

    private GuiButtonToggle btnToggleModuleName;
    private GuiButtonToggle btnToggleClassicMode;

    public ConfigCPS(ModuleCPS module) {
        super("CPS Display", 220, 120, module);
    }
    ...
    public void initGui() {
        ...
        this.btnToggleModuleName.setActive(ModuleCPS.showModuleName);
        ...
        this.btnToggleClassicMode.setActive(ModuleCPS.useClassicDesign);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 1) {
            ...
            ModuleCPS.showModuleName = this.btnToggleModuleName.getActiveState();

        } else if (button.id == 2) {
            this.btnToggleClassicMode.setActive(!this.btnToggleClassicMode.getActiveState());
            ModuleCPS.useClassicDesign = this.btnToggleClassicMode.getActiveState();
        }
