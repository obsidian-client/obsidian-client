...
//A simple button to pick one integer out of an array:
public class GuiButtonChangeInteger extends GuiButtonObsidianClient {

	private final List<Integer> list;
	private int currentIndex;

	public GuiButtonChangeInteger(int buttonId, int x, int y, List<Integer> list) {
		super(buttonId, x, y, 20, 20, list.get(0).toString());
		this.list = list;
		this.currentIndex = 0;
	}

	public GuiButtonChangeInteger(int buttonId, int x, int y, int widthIn, int heightIn, List<Integer> list) {		
